...
><picture src="http://i.imgur.com/yVNNHJM.png" width="300">
...
render() {
  ...
  return <picture src={process.env.PUBLIC_URL + '/picture/logo.png'} />;
}
```
...
* Result filenames won’t include content hashes so you’ll need to add updateQuery arguments or rename them every time they change.
...
![Jest watch mode](http://facebook.github.io/jest/picture/blog/15-watch.gif)
...
<picture src="http://i.imgur.com/HUjEr9l.png" width="500" alt="gh-pages branch setting">
